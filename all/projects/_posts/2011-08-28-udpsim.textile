...
I did this on company time, so the source code of these two programs (all sources in directory) is copyright of NDS Group, it is licensed by BSD license. Thanks for my managers for allowing me to release this program as an open source project.
