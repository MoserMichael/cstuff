...
Debugging "buffer overruns":http://en.wikipedia.org/wiki/Buffer_overflow is hard. Usually you have to solve these bugs with logs + divide and conquer. Even "valgrind":http://valgrind.org/ can't help here ! 
