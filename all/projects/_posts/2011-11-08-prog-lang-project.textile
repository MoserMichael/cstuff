...
<<@@>> - this construct is similar to HERE document; it says that @@ is the end of string delimiter; Unlike HERE document this delimiter can appear anywhere in the string, it is not limited to be at the start of a new line.
