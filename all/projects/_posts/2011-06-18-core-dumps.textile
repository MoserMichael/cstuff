...
Now script run.sh will first check if the executable has any debug information; if it does the gdb is run with copied shared libraries instead what is installed on your system.
