...
Now	
- One reason may be that the "stack is smashed":http://en.wikipedia.org/wiki/Stack_buffer_overflow in this case you can't get any information, sorry. (well we can help here, but that's a different story ...)
