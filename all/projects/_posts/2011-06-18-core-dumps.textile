...
h3. Interesting core dump trivia
...
-  "structure elf32_note": http://lxr.linux.no/#linux+v3.0.4/include/linux/elf.h#L402 is defined here, it describes the note header that describes the core file. So we should search for platform independent "elf_note":http://lxr.linux.no/#linux+v3.0.4/include/linux/elf.h#L422 
- Now function "elf_core_dump":http://lxr.linux.no/#linux+v3.0.4/fs/binfmt_elf.c#L1875 seems to be writing the core dump.
