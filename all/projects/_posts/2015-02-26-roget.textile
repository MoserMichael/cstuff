...
Please download the roget.py script "here":https://raw.githubusercontent.com/MoserMichael/cstuff/master/python/roget.py ; you also need to download the pd module "here":https://raw.githubusercontent.com/MoserMichael/cstuff/master/python/pd.py and place it into the same directory.
...
h3. Computing the semantic similarities between two terms;
