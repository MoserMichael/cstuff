...
Also please note that "RSA algorithm":http://en.wikipedia.org/wiki/RSA_(cryptosystem) is choose for this utility because there are "serious doubts":http://www.theguardian.com/world/2013/sep/05/nsa-how-to-remain-secure-surveillance in the validity of elliptic curve cryptography (given all those recent revelations)
...
Results are consistent with predictions. Now I could have achieved a greater speedup if I were to use the GPU of the graphics card, but this a bit too complex for an evening of work.
