...
This effect is achieved by means of sharing a public / private key pair - hence the name trusted key; Computer A owns the private key, computer B owns the public key; When Computer A tries to log in to computer B, the computer A encrypts a message with the private key; computer B can use the public key in order to decrypt and verity the message. 
