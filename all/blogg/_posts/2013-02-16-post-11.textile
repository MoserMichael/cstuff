...
Probably the system of local representatives creates the notion that there is a concrete address to what is going on in higher places.
 ...
 As for listening, Israelis have a problem with that. So there is no use in trying.
