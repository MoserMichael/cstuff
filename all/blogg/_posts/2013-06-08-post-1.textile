...
This call database contains records on all calls that have been made between two telephone numbers, it also knows the time and the duration of each call.
