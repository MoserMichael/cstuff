...
* It is possible to apply statistics / machine learning algorithms in order to extract significant clusters from the data; this would effectively create a map of society;
...
Lots of things are possible with such data; it is of course also a question of cost vs benefit, we don't know which measures were actually implemented in the end.
...
Is it all about policing grassroot organizations like the "occupy movement":http://en.wikipedia.org/wiki/Occupy_movement ? Might be, but I guess that would not be too constitutional.
