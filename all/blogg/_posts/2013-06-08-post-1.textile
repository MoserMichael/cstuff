...
What is learned here is that the measures that are taken by the state are proportional to the threat level perceived by the state; I don't know if such a strict level of surveillance is justified by the current level of insecurity, is this the real state of the union?
...
In the Sci-Fi novel "The Caves of steal":http://en.wikipedia.org/wiki/The_Caves_of_Steel by  Isaac Asimov they have an overpopulated and heavily urbanized planet Earth vs the space colonies; The space colonie are rich and have a low population density, unlike Earth they tolerate and use Robots. In the novel the Robot R. Daneel from a spacer world is working together with earth bound detective Elijah Baley.
...
Here it is, a book from the 50ies explains that one needs complex computers in order to cope with dissent in over complex societies. Good Sci-Fi is something of a crystal ball;
