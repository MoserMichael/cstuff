...
Any problems? In the last sentence the keyword is 'proper'; I think that this concept of intelligence needs some magic dust too:  I understand that the search for an analogy is equivalent to a query for a common trait/attribute or an opposite trait attribute. Now what trait is the relevant one? The same applies when inferring back from the matching  category to the initial situation: is there a procedure for deciding on what is relevant? 
