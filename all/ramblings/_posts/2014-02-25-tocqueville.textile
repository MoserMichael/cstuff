...
An extremely interesting book, Tocqueville makes the impression of having been an extremely good listener and observer, this books explains the events that caused the Revolution happened, by means of examining the history of the Ancient regime, in context with the preceding centuries before that event.
