 ...
 * every scrap of information would be used: see the "German tank problem":http://en.wikipedia.org/wiki/German_tank_problem were serial numbers of machine parts were used to create estimates of overall tank production.
   Electronic warfar/Radars turned into a complex beast
   <notextile>
   <iframe width="560" height="315" src="http://www.youtube.com/embed/?start=609&amp;listType=user_uploads&amp;list=ZTC_RxWN_xo" frameborder="0" allowfullscreen></iframe>
   </notextile>
