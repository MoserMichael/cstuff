...
---
h2. {{ page.title }}
<p class="publish_date">7 May 2018</p>
...
Obligatory Jethro Tull song: heavy horses https://www.youtube.com/watch?v=_GL6F2M7-gA
...
(says this ignores the risks of sedentism - it kills mobility and would be very bad for survival)
...
system https://en.wikipedia.org/wiki/Equal-field_system )
...
occurred (charcoal has more energy per cubic unit, easier to transport at distance)
* land clearance/deforestation leads to malaria (also detectable by archaeology)
* diminishing yields due to problems may lead to 'fading away' of the state (until populations just 
disperse)
* also war between states (either the defeated state is obliterated/population is transferred as a whole (or 
those with valuable skills/women of child bearing age), or it pays tribute)
* waging war contributes to fragility of the state (diverts manpower to the task/wall building); also a 
defensible position for the city is chosen (at the expense of better food production !)
* states that loose wars will have manpower running away (also prospect of conscription can do that 
with people)
* size of the state (its reach) depends on transportation costs (normally not greater than 40 kilometers); 
whoever the reach can be greater with water transport (costs less)! This leads to concentration of 
resources around palace/temple complex and its vulnerability (because of its concentration)
* early states lacked detailed accounting of yields (therefore over-taxation in bad year may cause 
hunger)
