...
This way of looking at XML is a simplification of sorts, but it is much easier to work with the data this sway rather than working with the "standard DOM API":http://www.w3.org/DOM/ ; 
...
h3. What should be the user experience
...
* Function calls with "Named parameters":http:// en.wikipedia.org/wiki/Named_parameter  ; various languages offer named parameters as an additional means of calling a function; I think that this should be the only way to call a function; It is much easier to read code that calls functions with named parameters; alas the notation for function calls is less compact.
...
* Perl: The way that  "Perlfunc / Perl Functions by  lCategory":http://www.oopweb.com/Perl/Documents/PerlDoc/Volume/pod/perlfunc.html  documents standard library functionality in a way similar to the Roget's thesaurus.
...
programming; it is a procedural and imperative language; that means that its has functions and and assignments operator. 
...
Please see "oo feature":../07/feature-oo.html	
...
h3. Defining the Pooh language in some more detail

(R1) Language must be dynamically typed; 
...
(see more in "type checking feature":../07/feature-typecheck.html
...
Please see "values feature":../07/feature-values.html for a detailed discussion of the topic.
...
Please see "function feature":../07/feature-functions.html
...
"more on threads":../07/feature-threads.html 
...
(R16) String literals; 
Please see "string literals":../07/feature-string-literals.html	 
