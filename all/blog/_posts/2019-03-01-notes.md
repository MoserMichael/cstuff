...
Here are my notes on lerarning about Kubernetes [pdf notes here](https://github.com/MoserMichael/cstuff/releases/download/kbook-upd/kubernetes-book.pdf)

and here some notes on learning about [Kubernetes operators](https://github.com/MoserMichael/cstuff/releases/download/k8sop/kubernetes-operators.pdf)

Some notes on learning [the go language](https://github.com/MoserMichael/cstuff/releases/download/lgolang/learning-go-lang.pdf)

Here are my notes on learning tmux, a real time saver  [learning tmux](https://github.com/MoserMichael/cstuff/releases/download/new-stuff-learned/learning-tmux.pdf)
