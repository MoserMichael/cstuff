...
Helps to distinguish between proper git files and generated files (if you are using code generation as part of the build process then that can be quite useful)
