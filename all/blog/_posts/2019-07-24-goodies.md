...
a script to push your local image to a docker repository [link to script](https://github.com/MoserMichael/myenv/blob/master/kubernetes-utils/docker-push-repo.sh) by default the repository is quay.io
