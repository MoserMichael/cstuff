...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     TK_SEMICOLON = 312,
     TK_COMMA = 313,
     TK_PARENTHESES_OPEN = 314,
     TK_PARENTHESES_CLOSE = 315,
     TK_BRACE_OPEN = 316,
     TK_BRACE_CLOSE = 317,
     TK_BYREF = 318,
     TK_OPTIONAL = 319,
     TK_THREE_DOTS = 320,
     TK_UNDERSCORE = 321,
     TK_BRACKET_CLOSE = 322,
     TK_BRACKET_OPEN = 323,
     TK_ALTERNATIVE_CHOICE = 324,
     TK_START_STATEMENT = 325,
     TK_START_EXPRESSION = 326,
     TK_START_PGRAMMAR = 327,
     TK_PARAMETER_LABEL = 328,
     TK_GRAMMAR_DELIM = 329,
     TK_RULE_NAME = 330,
     TK_RULE_REFERENCE = 331,
     TK_CHARACTER = 332,
     TK_ESCAPE_SEQUENCE = 333,
     TK_ANY = 334,
     TK_SOME = 335,
     TK_NONE = 336,
     TK_UNTIL = 337,
